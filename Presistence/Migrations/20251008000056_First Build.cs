    ...
    public partial class FirstBuild : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Drivers", x => x.NationalId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverLocation_Latitude = table.Column<double>(type: "float", nullable: true),
                    DriverLocation_Longitude = table.Column<double>(type: "float", nullable: true),
                    OrderLocation_Latitude = table.Column<double>(type: "float", nullable: false),
                    OrderLocation_Longitude = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Drivers_NationalId",
                        column: x => x.NationalId,
                        principalTable: "Drivers",
                        principalColumn: "NationalId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Vehicles_VehicleNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_NationalId",
                table: "Orders",
                column: "NationalId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_VehicleNumber",
                table: "Orders",
